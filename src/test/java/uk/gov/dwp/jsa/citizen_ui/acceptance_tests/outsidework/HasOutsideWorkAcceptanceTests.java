package uk.gov.dwp.jsa.citizen_ui.acceptance_tests.outsidework;
...
public class HasOutsideWorkAcceptanceTests {

    private static final String FORM_URL = "/form/outside-work/has-outside-work";
    private static final String NEXT_URL = "/form/pensions/current/has-pension";
    private static final String ALT_NEXT_URL = "/form/pensions/current/has-pension";
    ...
    @Test
    public void post_WithYesSelected_ReturnsHasCurrentPensionForm() throws Exception {
    ...
    @Test
    public void post_WithNoSelected_ReturnsHasCurrentPensionForm() throws Exception {
