...
public class VoluntaryPaidAcceptanceTests {

    private static final String GET_URL = "/form/current-work/details/%s/get-paid";
    private static final String POST_URL = "/form/current-work/details/1/get-paid";
    private static final String ALT_NEXT_URL = "/form/current-work/details/%s/how-often-paid";
    private static final String NEXT_URL = "/form/current-work/details/%s/name";
    ...
    @Test
    public void post_WithYesSelected_ReturnsAltNextAndChoiceSaved() throws Exception {
    ...
    @Test
    public void post_WithNoSelected_ReturnsNextAndChoiceSaved() throws Exception {
        Claim claim = new Claim();
        claimRepository.save(claim);
