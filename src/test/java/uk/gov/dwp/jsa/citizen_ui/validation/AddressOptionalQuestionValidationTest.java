...
public class AddressOptionalQuestionValidationTest {
    ...
    public void anAddressLineShouldBeLimitedToMaximumLength() {
        ...
        addressQuestion.setAddressLine2(ADDRESS_QUESTION_THAT_EXCEEDS_THE_MAX_LENGTH);
        assertThat(addressQuestion.getAddressLine2().length(), is(ADDRESS_MAX_LENGTH));
    }
    ...
    private class AddressCodeQuestionWrapper {
        ...
        public Set<ConstraintViolation<AddressQuestion>> validate(final String line) {
            ...
            addressQuestion.setAddressLine2(line);
