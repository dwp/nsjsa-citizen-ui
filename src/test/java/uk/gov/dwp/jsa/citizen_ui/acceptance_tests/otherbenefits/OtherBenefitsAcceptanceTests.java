...
public class OtherBenefitsAcceptanceTests {

    private static final String FORM_URL = "/form/other-benefits/have-you-applied";
    private static final String NEXT_URL = "/form/other-benefits/details";
    private static final String ALT_NEXT_URL = "/form/claim-start/jury-service/have-you-been";
    ...
    @Test
    public void post_WithYesSelected_ReturnsOtherBenefitsDetailsForm() throws Exception {
    ...
    @Test
    public void post_WithNoSelected_ReturnsJuryServiceForm() throws Exception {
