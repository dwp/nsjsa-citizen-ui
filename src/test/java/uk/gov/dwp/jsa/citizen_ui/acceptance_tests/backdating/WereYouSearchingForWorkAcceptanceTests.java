...
public class WereYouSearchingForWorkAcceptanceTests {
    private static final String WERE_YOU_AVAILABLE_FOR_WORK_URL = "/form/backdating/were-you-searching-for-work";
    private static final String NEXT_PAGE = "/form/backdating/why-not-apply-sooner";
    ...
    private final String PAGE_TITLE = "Were you searching for work from " + formattedDate + "?";
    ...
    @Test
    public void getWereYouSearchingForWork_ReturnsForm() throws Exception {
    ...
    @Test
    public void postWereYouSearchingForWork_WithYesSelected_redirectsToNextPage() throws Exception {
    ...
    @Test
    public void postWereYouSearchingForWork_WithNoSelected_redirectsToNextPage() throws Exception {
        mockMvc.perform(post(WERE_YOU_AVAILABLE_FOR_WORK_URL)
                .with(csrf())
                .param("question.choice", "true"))
                .andExpect(status().isFound())
    ...
    @Test
    public void postWereYouSearchingForWork_WithEmptySelection_staysOnPageWithCorrectErrors() throws Exception {
        mockMvc.perform(post(WERE_YOU_AVAILABLE_FOR_WORK_URL)
