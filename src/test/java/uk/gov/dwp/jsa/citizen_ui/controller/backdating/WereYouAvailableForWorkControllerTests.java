...
public class WereYouAvailableForWorkControllerTests {
    private static final String EXPECTED_VIEW = "form/backdating/were-you-available-for-work";

    private WereYouAvailableForWorkController wereYouAvailableForWorkController;
    ...
    public void setUp() {
        ...
        wereYouAvailableForWorkController = new WereYouAvailableForWorkController(mockClaimRepository, mockRoutingService,
    ...
    public void getWereYouAvailableForWork_returnsCorrectView() {
        ...
        String result = wereYouAvailableForWorkController.getWereYouAvailableForWork(mockModel, claimID, mockRequest);
        assertEquals(EXPECTED_VIEW, result);
    }

    @Test
    public void postWereYouAvailableForWork_returnsCorrectView() {
        String expected = "/form/backdating/were-you-searching-for-work";
        ...
        String result = wereYouAvailableForWorkController.postWereYouAvailableForWork(
    ...
    public void testLoadData() {
        ...
        backDating.setWereYouAvailableForWork(true);
        ...
        wereYouAvailableForWorkController.loadForm(claimDB, booleanForm);
