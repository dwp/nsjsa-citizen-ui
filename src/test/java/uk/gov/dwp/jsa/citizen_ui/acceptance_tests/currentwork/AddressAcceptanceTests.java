...
public class AddressAcceptanceTests {
    @Autowired
    ...
    public void GetEmployerAddress_ReturnsEmployerAddressForm() throws Exception {
        mockMvc.perform(get("/form/current-work/details/1/address").with(csrf()))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("id=\"address\"")));
    }

    @Test
    public void GivenValidEmployerAddress_PostForm_ReturnsHours() throws Exception {
        String line1 = "line 1";
        String line2 = "line 2";
        String townOrCity = "town or city";
        String postCode = "PO1 3AX";
        mockMvc.perform(
                post("/form/current-work/details/1/address")
                        .with(csrf())
                ...
                .andExpect(header().string("Location", "/form/current-work/details/1/hours"));
    }
