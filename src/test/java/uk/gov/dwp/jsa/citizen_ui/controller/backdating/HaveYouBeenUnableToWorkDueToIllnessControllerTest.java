...
public class HaveYouBeenUnableToWorkDueToIllnessControllerTest {
    ...
    private HaveYouBeenUnableToWorkDueToIllnessController sut;
    @Mock
    ...
    @Mock
    private UnableToWorkDueToIllnessForm mockUnableToWorkDueToIllnessForm;
    @Mock
    private BindingResult mockBindingResult;
    @Mock
    private UnableToWorkDueToIllnessQuestion mockQuestion;
    @Mock
    ...
    @Before
    public void setUp() {
//        mockUnableToWorkDueToIllnessForm = mock(mockUnableToWorkDueToIllnessForm.class);
        ...
        sut = new HaveYouBeenUnableToWorkDueToIllnessController(mockClaimRepository, mockRoutingService,
                mockDateFormatterUtils, mockResolver);
    }

    @Test
    public void getHaveYouBeenUnableToWorkDueToIllness_successfulGetRequest_ReturnsExpectedView() {
        ...
        String view = sut.getHaveYouBeenUnableToWorkDueToIllness(mockModel, CLAIM_ID, mockRequest);

        assertEquals(view, IDENTIFIER);
    }

    @Test
    public void postHaveYouBeenUnableToWorkDueToIllness_successfulPostRequest_redirectsExpectedView() {
        when(mockClaim.getId()).thenReturn(CLAIM_ID);
        when(mockUnableToWorkDueToIllnessForm.getQuestion()).thenReturn(mockQuestion);
        ...
        String view = sut.
                postHaveYouBeenUnableToWorkDueToIllness(mockUnableToWorkDueToIllnessForm, mockBindingResult, CLAIM_ID,
    ...
    public void getForm_ReturnsStringForm() {
        ...
        assertEquals(form.getClass(), UnableToWorkDueToIllnessForm.class);
    }
