...
@Controller
@RequestMapping(path = "/form/current-work/details")
public class CurrentWorkAddressController extends CounterFormController<EmployersAddressForm> {

    public static final String IDENTIFIER = "form/current-work/details/address";
    public static final String IDENTIFIER_TEMPLATE = "form/current-work/details/%s/address";

    public CurrentWorkAddressController(final ClaimRepository claimRepository, final RoutingService routingService) {
        super(claimRepository,
                "form/current-work/details/address",
                FORM_NAME,
                routingService,
              IDENTIFIER,
                "/form/current-work/details/%s/hours",
                NO_ALTERNATIVE_IDENTIFIER,
                Section.CURRENT_WORK);
    }

    @GetMapping(path = "/{count:[1-4]+}/address")
    ...
    @PostMapping(path = "/{count:[1-4]+}/address")
    ...
    @Override
    public void setFormAttrs(final EmployersAddressForm form, final String claimId) {
