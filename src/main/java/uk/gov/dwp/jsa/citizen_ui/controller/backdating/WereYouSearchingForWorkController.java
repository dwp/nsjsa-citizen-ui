...
@Controller
@RequestMapping("/" + WereYouSearchingForWorkController.IDENTIFIER)
public class WereYouSearchingForWorkController extends AvailableAndSearchingBase {
    public static final String IDENTIFIER = "form/backdating/were-you-searching-for-work";

    @Autowired
    private CookieLocaleResolver cookieLocaleResolver;

    public WereYouSearchingForWorkController(final ClaimRepository claimRepository,
        ...
        super(claimRepository,
                ...
                routingService,
                IDENTIFIER,
                "/" + WhyNotApplySoonerController.IDENTIFIER,
                dateFormatterUtils,
    ...
    @GetMapping
    public final String getWereYouSearchingForWork(
            final Model model,
    ...
    @PostMapping
    public final String postWereYouSearchingForWork(@ModelAttribute(FORM_NAME) @Valid final BooleanForm<BooleanQuestion> form,
    ...
    public void loadForm(final ClaimDB claimDB, final BooleanForm<BooleanQuestion> form) {
        resolve(() -> claimDB.getCircumstances().getBackDating().getWereYouSearchingForWork())
                .ifPresent(searchingForWork -> form.getQuestion().setChoice(searchingForWork));
    }
}
