...
@Controller
@RequestMapping("/" + HaveYouBeenInPaidWorkSinceController.IDENTIFIER)
public class HaveYouBeenInPaidWorkSinceController extends BaseFormController<BooleanForm<BooleanQuestion>> {
    public static final String IDENTIFIER = "form/backdating/have-you-been-in-paid-work-since";
    ...
    public HaveYouBeenInPaidWorkSinceController(final ClaimRepository claimRepository,
        ...
        super(claimRepository,
                ...
                routingService,
                IDENTIFIER,
                "/" + HaveYouBeenUnableToWorkDueToIllnessController.IDENTIFIER,
    ...
    @GetMapping
    public final String getHaveYouBeenInWorkSince(
            final Model model,
    ...
    @PostMapping
    public final String postHaveYouBeenInWorkSince(
    ...
    public void setFormAttrs(final BooleanForm<BooleanQuestion> form, final String claimId) {
        form.setTranslationKey("backdating.been.in.work.since.");
        super.setFormAttrs(form, claimId);
    }

    @Override
    public void loadForm(final ClaimDB claimDB, final BooleanForm<BooleanQuestion> form) {
        resolve(() -> claimDB.getCircumstances().getBackDating().getInPaidWorkSince())
                .ifPresent(inPaidWork -> form.getQuestion().setChoice(inPaidWork));
    }
}
